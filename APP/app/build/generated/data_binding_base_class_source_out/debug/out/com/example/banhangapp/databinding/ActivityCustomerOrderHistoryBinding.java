...
public final class ActivityCustomerOrderHistoryBinding implements ViewBinding {
  ...
  @NonNull
  public static ActivityCustomerOrderHistoryBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityCustomerOrderHistoryBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_customer_order_history, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityCustomerOrderHistoryBinding bind(@NonNull View rootView) {
